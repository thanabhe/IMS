              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" action="proses_updloadBarang.php" data-parsley-validate class="form-horizontal form-label-left" method="post">
                    <div class="form-group">                       
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">File <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="last-name" name="tgl_kirim" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
