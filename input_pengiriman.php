                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" action="proses_sementara.php" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <tbody>
                        <?php  
                          $no = 1;
                          $result = $mysqli->query("SELECT * from tblsementara,tblbarang where tblsementara.matnr = tblbarang.matnr and tblsementara.username = '$user' ");
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" action="proses_inputPengiriman.php" data-parsley-validate class="form-horizontal form-label-left" method="post">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="penerima" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tanggal Kirim <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
